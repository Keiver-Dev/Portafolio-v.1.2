...
export default function Slade3() {
  return (
    <div className="flex flex-col xl:flex xl:flex-row gap-2">
      <div className="flex p-4 xl:flex xl:flex-col justify-between xl:justify-center text-center items-center xl:p-4 gap-2 border border-zinc-500 xl:rounded-bl-lg">
  ...
  <a href="https://github.com/Keiver-Dev/PixelArt-Gallery">
    <img
      ...
      src={`${import.meta.env.BASE_URL}Gallery.png`}
      alt="Spotify"
    />
  </a>
</div>
